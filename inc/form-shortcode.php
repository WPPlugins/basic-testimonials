...
function basic_testimonials_form_shortcode_html( $atts ) {
    ...
    $html = '<p>' . esc_html( $form_message ) . '</p>'; 
    ...
    $html .= '<p><label for="basic_testimonial_thumbnail">' . esc_html__( 'Upload a nice photo ! (200px by 200px .png or .jpg)', 'basic-testimonials' ) . '</label><br />';
    $html .= '<input type="file" id="basic_testimonial_thumbnail" name="basic_testimonial_thumbnail" multiple="false" accept="image/png, image/jpeg" /></p>';
...
function basic_testimonials_process_form() {
    ...
    if ( wp_check_filetype( $_FILES['basic_testimonial_thumbnail']['name'] ) ) {
...
function basic_testimonials_captcha_field(){
    ...
    $html  = '<input type="hidden" name="basic_testimonials_form_captcha_token" value="' . $token . '" />';
    $html .= '<p><label for="basic_testimonials_form_captcha_answer">' . esc_html__( 'Please show you\re human.', 'basic-testimonials' ) . '</label>';
